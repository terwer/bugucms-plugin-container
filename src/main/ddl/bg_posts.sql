CREATE TABLE bg_posts (
  ...
  post_date datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '发表时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=7843 DEFAULT CHARSET=utf8mb4 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='文章表';
