                ...
                <div class="uc-sign-up-wrapper uc-wrapper uc-page">
                    <div class="uc-mod-sign-up uc-clearfix">
                        <div class="uc-main">
                            ...
                            <form class="uc-form" method="post" action="https://i.360.cn/signUp/dosignUpAccount">
                                <div>
                                    ...
                                    <span class="uc-tip"></span>
                                    <p class="uc-field uc-field-captcha uc-input-short" style="display: block;"><img class="uc-captcha-img uc-captcha-change" alt="验证码" title="点击更换" tabindex="99" src="http://passport.360.cn/captcha.php?m=create&amp;app=i360&amp;scene=strictreg&amp;userip=&amp;level=default&amp;sign=5a63a7&amp;r=1522609504&amp;_=1522609505099">
                                    ...
                                    <span class="uc-tip"></span>
                                    <p class="uc-field uc-next-step uc-clearfix"><a href="#" class="uc-nextAndGet-sms-token">下一步</a></p>
                                ...
                                <p class="uc-field uc-field-smscodetip"><span><a class="uc-link" href="http://i.360.cn/findpwd/customerhelper#recievemobilecode" target="_blank">短信验证码没收到？</a></span></p>
                                <p class="uc-field uc-field-licence"><label><span>点击“下一步”，即表示您已同意并愿意遵守<a class="uc-link" href="http://i.360.cn/pub/protocol.html" target="_blank">《360用户服务条款》</a></span></label></p>
                                <p class="uc-login">已有帐号，<a href="#" class="uc-link uc-link-login">立即登录</a></p>
                            </form>
                        </div>
                    </div>
                </div>
