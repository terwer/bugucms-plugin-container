package com.terwergreen.bugucms.middle.user.service.impl;

import com.terwergreen.core.service.BaseService;
...
import com.terwergreen.bugucms.middle.user.util.Constants;
...
public class LoginServiceImpl extends BaseService implements LoginService {
    ...
    public boolean isLogin(HttpSession session) {
        String mobile = (String) session.getAttribute(com.terwergreen.bugucms.front.user.util.Constants.SESSION_ACCOUNT_MOBILE);
