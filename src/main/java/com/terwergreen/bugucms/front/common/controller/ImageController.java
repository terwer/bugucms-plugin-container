package com.terwergreen.bugucms.front.common.controller;
...
public class ImageController extends BGBaseController {
	 ...
	 * @date 2018-04-02 13:36:00
	 */
	@RequestMapping("/common/imgVerifyKaptcha")
	@ResponseBody
	public RestResponseDTO imgVerifyKaptcha(HttpServletRequest request, HttpServletResponse response,
