package com.terwergreen.bugucms.front.user.controller;
...
import com.terwergreen.bugucms.front.common.util.HttpUtils;
...
import com.terwergreen.bugucms.middle.user.dto.UserDTO;
import com.terwergreen.bugucms.middle.user.service.LoginService;
...
public class LoginController extends BGBaseController {
    ...
    public RestResponseDTO login(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            //登录校验成功，返回登录信息
            if (com.terwergreen.bugucms.front.common.util.Constants.BG_ZERO.equals(loginStatus)) {
                ...
                //账号不存在
            } else if (com.terwergreen.bugucms.front.common.util.Constants.BG_ONE.equals(loginStatus)) {
