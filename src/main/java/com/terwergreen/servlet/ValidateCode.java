package com.terwergreen.servlet;
...
public class ValidateCode {
	protected static final Logger logger=LogManager.getLogger(ValidateCode.class);
	...
	public void createCode() {
		...
		x = (width -20)/ (codeCount)+3;// 每个字符的宽度
		...
		for (int i = 0; i < codeCount; i++) {
			...
			blue = random.nextInt(255);
			g.setColor(new Color(red, green, blue));
			g.drawString(strRand, (i + 1) * x-15, codeY);
	...
	public boolean write(OutputStream sos) throws IOException {
